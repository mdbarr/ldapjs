...
for (k in Protocol) {
  if (Protocol.hasOwnProperty(k)) {module.exports[k] = Protocol[k];}
}

for (k in messages) {
  if (messages.hasOwnProperty(k)) {module.exports[k] = messages[k];}
}

for (k in controls) {
  if (controls.hasOwnProperty(k)) {module.exports[k] = controls[k];}
}
