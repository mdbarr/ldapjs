...
Object.defineProperties(LDAPError.prototype, {
  ...
  message: {
    get: function getMessage() {
      return this.ldapMessage || this.name;
    },
    configurable: false
  },
  dn: {
    get: function getDN() {
      return this.ldapDN ? this.ldapDN.toString() : '';
    },
    configurable: false
  }
});
...
Object.defineProperties(ConnectionError.prototype, { name: {
...
Object.defineProperties(AbandonedError.prototype, { name: {
  get () { return 'AbandonedError'; },
  configurable: false
} });
...
Object.defineProperties(TimeoutError.prototype, { name: {
